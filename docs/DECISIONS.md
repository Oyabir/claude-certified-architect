...
- 2026-09-23 · Serveur de test joignable depuis Windows Sandbox · nom licences.pcsante.test ajouté au fichier hosts de la Sandbox (passerelle = hôte), règle de pare-feu limitée au port 5080 et aux sous-réseaux locaux · l'adresse de la passerelle change à chaque lancement.
